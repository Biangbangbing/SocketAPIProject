 ...
 * @version: 1.0
 */
public class ServerListener implements ActionListener, MouseListener, ListSelectionListener {
    ServerUI serverUI;
    JFrame jFrame;
    JTextArea inputArea;
    JTextArea showArea;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (BtnStr.equals("发送")) {
            ...
            //发送消息
            Socket socket = serverUI.getSocket();
            try {
